        ...
        <tbody>
            @forelse($publishers as $publisher)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('publishers.show', $publisher) }}" class="btn btn-info btn-sm">Visualizar</a>
                        ...
                        <form action="{{ route('publishers.destroy', $publisher) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm" onclick="return confirm('Excluir esta editora?')">Excluir</button>
                        </form>
                    </td>
                </tr>
            @empty
