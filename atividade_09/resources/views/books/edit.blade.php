...
<div class="container">
    ...
    <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
        ...
        @if ($book->cover)
            <div class="mb-3">
                <p>Imagem atual:</p>
                <img src="{{ asset('storage/' . $book->cover) }}" alt="Capa do Livro" style="max-height: 200px;" class="img-thumbnail">
            </div>
        @endif

        <div class="mb-3">
            <label for="cover" class="form-label">Nova Imagem de Capa (opcional)</label>
